...
<div class="row">
  ...
  <div class="col-md-8 form-group">
		 <form class="form-inline" method="post" id="this_page">
		<div id="paging_container_div" class="opt_bar">
			...
			<div class="form-group" id="page_range_text">Showing page {{$page_num}} of {{$total_pages}}</div>
		   
				<div  class="form-group">
					<label>Go to page:</label>
				</div><div  class="form-group">
					<input class="form-control" type="text" name="goto" id="goto" value="1" />
				</div><div  class="form-group">
					<a class="btn btn-info" id="paging_settings" href="javascript:void(0);">GO</a>
				</div>
				
				<div  class="form-group">
				
					<label>Show rows:</label>
					<select class="form-control"  name="page_size" id="page_size" !id="show_row" !name="show_row">
