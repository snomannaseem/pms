                ...
                <div class="panel">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <div class="grid_box" id="this_grid">
                            ...
                            ?>
                            <!--GRID-->
                                @include('ui.module_actions.modules_actions_grid',['header' => [] , 'paging_result_set' => $data_set])
                            <!-- GRID End -->
                        </div>
...
<script type="text/javascript">
	var grid_list_page_name = 'module_actions';
	var grid_edit_page_name = 'module_actions';
</script>
