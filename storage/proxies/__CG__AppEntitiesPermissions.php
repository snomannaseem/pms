 ...
 */
class Permissions extends \App\Entities\Permissions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'permission', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'description', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'createdOn', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'updatedOn', '' . "\0" . 'App\\Entities\\Permissions' . "\0" . 'deletedOn'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Permissions $proxy) {
