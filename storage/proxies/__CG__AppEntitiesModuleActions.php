 ...
 */
class ModuleActions extends \App\Entities\ModuleActions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ModuleActions' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ModuleActions' . "\0" . 'url', '' . "\0" . 'App\\Entities\\ModuleActions' . "\0" . 'description', '' . "\0" . 'App\\Entities\\ModuleActions' . "\0" . 'action', '' . "\0" . 'App\\Entities\\ModuleActions' . "\0" . 'module'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ModuleActions $proxy) {
