 ...
 */
class UserRoles extends \App\Entities\UserRoles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'createdOn', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'updatedOn', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'deletedOn', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'role', '' . "\0" . 'App\\Entities\\UserRoles' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserRoles $proxy) {
